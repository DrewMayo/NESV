...
#
# Generated by export_simulation on Sat May 03 01:35:59 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './pgr_rom.sh' script.

./pgr_rom.sh -reset_run
...
./pgr_rom.sh -noclean_files

For more information on the script, please type './pgr_rom.sh -help'.
