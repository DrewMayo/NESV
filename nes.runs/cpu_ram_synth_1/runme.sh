...
HD_PWD='/home/drew/uiuc/ece385/nes/nes.runs/cpu_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_ram.tcl
