...
HD_PWD='C:/Users/Mark/Documents/NESV/NESV/nes.runs/frame_buffr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frame_buffr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source frame_buffr.tcl
