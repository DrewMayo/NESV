...
HD_PWD='C:/Users/Mark/Documents/NESV/NESV/nes.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nes.tcl -notrace
