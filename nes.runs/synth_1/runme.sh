...
HD_PWD='C:/Users/Mark/Documents/NESV/NESV/nes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nes.tcl
